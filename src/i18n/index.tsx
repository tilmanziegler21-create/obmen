...
const dictionaries: Record<Language, TranslationDictionary> = {
  ru: {
    ...
    home: {
      ...
      seeAll: 'Смотреть все ->',
      workingInGermany: 'РАБОТАЕМ В ГЕРМАНИИ',
      germanyCitiesList: 'Франкфурт, Берлин, Мюнхен, Гамбург',
  ...
  en: {
    ...
    home: {
      ...
      seeAll: 'See all ->',
      workingInGermany: 'WORKING IN GERMANY',
      germanyCitiesList: 'Frankfurt, Berlin, Munich, Hamburg',
  ...
  uk: {
    ...
    home: {
      ...
      seeAll: 'Дивитися всі ->',
      workingInGermany: 'ПРАЦЮЄМО В НІМЕЧЧИНІ',
      germanyCitiesList: 'Франкфурт, Берлін, Мюнхен, Гамбург',
  ...
  de: {
    ...
    home: {
      ...
      seeAll: 'Alle ansehen ->',
      workingInGermany: 'WIR ARBEITEN IN DEUTSCHLAND',
      germanyCitiesList: 'Frankfurt, Berlin, München, Hamburg',
