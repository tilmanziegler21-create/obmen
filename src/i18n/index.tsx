...
const dictionaries: Record<Language, TranslationDictionary> = {
  ru: {
    ...
    home: {
      ...
      commissionIncluded: 'Все комиссии и сборы включены в курс',
      ...
      minAmountError: 'Минимальная сумма обмена — {{amount}} EUR (или эквивалент)',
  ...
  en: {
    ...
    home: {
      ...
      commissionIncluded: 'All fees and commissions are included in the rate',
      ...
      minAmountError: 'Minimum exchange amount is {{amount}} EUR (or equivalent)',
  ...
  uk: {
    ...
    home: {
      ...
      commissionIncluded: 'Всі комісії та збори включені в курс',
      ...
      minAmountError: 'Мінімальна сума обміну — {{amount}} EUR (або еквівалент)',
  ...
  de: {
    ...
    home: {
      ...
      commissionIncluded: 'Alle Gebühren und Provisionen sind im Kurs enthalten',
      ...
      minAmountError: 'Mindestbetrag für den Tausch — {{amount}} EUR (oder Äquivalent)',
